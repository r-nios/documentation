...
import HeroImage from "./hero-preview.png";
    ...
    <>
      {showShaders && (
        <GrainGradient
          ...
          colors={
            resolvedTheme === "dark"
              ? ["#6F3CFF", "#4F6BFF", "#00000000"]
              : ["#EEE8FF", "#C9D4FF", "#00000000"]
          }
          colorBack="#00000000"
          softness={1.4}
          intensity={0.45}
      ...
      {showShaders && (
        <Dithering
          ...
          height={720}
          colorBack="#00000000"
          colorFront={resolvedTheme === "dark" ? "#4C5FE0" : "#C8D3FF"}
          shape="sphere"
          type="4x4"
          scale={0.5}
          size={3}
