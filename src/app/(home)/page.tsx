...
const buttonVariants = cva(
  "inline-flex justify-center px-5 py-3 rounded-full font-medium tracking-tight transition-colors",
  {
    variants: {
      variant: {
        primary: "bg-brand bg-indigo-500 text-white hover:bg-indigo-600",
        secondary:
    ...
    <main className="text-landing-foreground pt-4 pb-6 dark:text-landing-foreground-dark md:pb-12">
      <div className="relative flex min-h-[600px] h-[70vh] max-h-[900px] border rounded-2xl overflow-hidden mx-auto w-full max-w-[1400px] bg-origin-border">
        ...
        <div className="flex flex-col z-2 px-4 size-full md:p-12 max-md:items-center max-md:text-center">
          <p className="mt-12 text-xs text-brand font-medium rounded-full p-2 border w-fit border-white/50 bg-white/10 backdrop-blur-sm">
            the docs nios students need.
          </p>

          <h1 className="text-4xl my-8 leading-tighter font-medium xl:text-5xl xl:mb-12">
            Student-made
            <br className="md:hidden" /> NIOS documentation,
            <br />
            for <span className="text-brand">students</span>.
          </h1>
          ...
          <div className="flex flex-row items-center justify-center gap-4 flex-wrap w-fit">
            <Link
              ...
              className={cn(
                buttonVariants(),
                "max-sm:text-sm gap-2 flex items-center",
              )}
            >
              Getting Started
            ...
            <a
              href="https://discord.gg/pqb4Xz5ash"
              target="_blank"
            ...
            >
              Open Community Chat
              <MessageSquare className="size-5 ml-2" />{" "}
            </a>
          </div>
        </div>
      </div>
      <div className="grid grid-cols-1 gap-10 mt-12 px-6 mx-auto w-full max-w-[1400px] md:px-12 lg:grid-cols-2">
        <p className="text-2xl tracking-tight leading-snug font-light col-span-full md:text-3xl xl:text-4xl">
          This is a{" "}
          <span className="text-brand font-medium">student-built</span>{" "}
          documentation platform created for{" "}
          <span className="text-brand font-medium">NIOS Students</span>,
          designed to simplify everything from admissions to exams. Built by
          students, for students, it brings together clear guides, practical
          resources, and real-world insights to help you navigate National
          Institute of Open Schooling (NIOS) with confidence and ease.
        </p>

        <div className="p-2 bg-radial-[circle_at_top_center] from-25% to-brand-secondary/50 rounded-xl col-span-full">
  ...
  return (
    <>
      ...
      <div className={cn(cardVariants(), "flex flex-col")}>
        ...
        >
          Simple, student-friendly, and built for NIOS.
        </h3>
        <p className="mb-4">
          r-NIOS is a community-driven documentation site that explains NIOS
          admissions, subjects, exams, results, and study centres in plain,
          easy-to-understand language.
        </p>
        <p className="mb-4">
          No confusing PDFs or scattered notices — just structured guides,
          step-by-step explanations, and real student insights, all in one
          place.
        </p>
        <CodeBlock
          code={`Explore → Learn → Clear your NIOS exams\n\nr-nios.in | Documentation by students, for students`}
          lang="bash"
        />
      </div>
    </>
...
<auto-type-table path='./my-file.ts' name='CardProps' />`}
            ...
            <div className="max-lg:row-start-1">
              ...
              <p>
                ...
                latest data from database, server — anywhere, to be part of the
                content.
              </p>
              <ul className="text-xs list-disc list-inside mt-8">
                ...
                <li>OpenAPI playground for documenting the APIs</li>
              </ul>
            </div>
          </div>
        ),
...
const feedback = [
  {
    ...
    user: "Rahul S.",
    role: "NIOS Class 12 Student",
    message: `r-nios.in cleared up so much confusion for me.

From admissions to exam rules, everything is explained in simple language.


Way better than digging through random PDFs and some other community sources.
...
TYSM! <3`,
  },
  {
    ...
    user: "Ananya K.",
    role: "NIOS Secondary (Class 10)",
    message: `This site feels like NIOS explained by seniors who actually understand students.

The subject structure and exam info helped me plan my year properly.`,
  },
  {
    avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=tutor1",
    user: "Vikram D.",
    role: "NIOS Tutor",
    message: `I recommend r-nios.in to my students regularly.

It's clean, accurate, and removes a lot of myths around NIOS admissions and exams.`,
  },
  {
    avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=student3",
    user: "Sneha P.",
    role: "Drop Year Student",
    message: `If you're new to NIOS, this is the best starting point.

Everything is structured like proper documentation instead of scattered blog posts.`,
  },
  {
    avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=student4",
    user: "Arjun M.",
    role: "Govt Exam Aspirant",
    message: `NIOS felt confusing until I found r-nios.in.

The clarity about certification validity and subjects helped me focus on my exam prep.`,
  },
];
  ...
  return (
    <>
      <div className={cn(cardVariants())}>
        ...
        <p className="mb-6">
          Straightforward explanations of NIOS processes, without promotional
  ...
  return (
    <>
      ...
      <div className={cn(cardVariants({ className: "flex flex-col" }))}>
        ...
        <p className="mb-8">
          This guide is 100% powered by passion and open source community.
        </p>
        <div className="mb-8 flex flex-row items-center gap-2">
          ...
          <a
            href="https://github.com/r-nios/documentation/graphs/contributors"
            rel="noreferrer noopener"
