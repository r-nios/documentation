...
export default async function Page() {
  ...
  return (
    ...
    //   />
    //   <h1 className="text-4xl font-semibold">Support r/NIOS</h1>
    //   <p className="mt-4 text-sm">
    //     Your sponsorship means a lot to open-source projects, including r/NIOS.
    //   </p>
    //   <a
    ...
    <main className="relative w-full max-w-page mx-auto flex flex-col items-center px-4 py-20 text-center overflow-hidden">
      {/* background glow */}
      <div className="absolute inset-0 -z-10 flex justify-center">
        <div className="h-[400px] w-[400px] rounded-full bg-pink-500/10 blur-3xl dark:bg-purple-500/10" />
      </div>
      ...
      <p className="mt-4 max-w-xl text-sm text-fd-muted-foreground">
        This site is built by students, for students. No ads, no paywalls — just
        free help. If it helped you even a little, please consider sponsoring us
        🐾
      </p>

      {/* neko */}
      <div className="mt-10 font-mono text-sm leading-tight text-left bg-fd-card border border-fd-border rounded-xl px-6 py-4 shadow-sm">
        <pre className="text-center">
          {` /\_/\ 
( o.o )  < pls sponsor us...
 > ^ <    we run on hopes & coffee ☕`}
        </pre>
      </div>
      ...
      <a
        ...
        className={cn(
          buttonVariants({
            className:
              "mt-8 rounded-full px-8 text-sm animate-pulse hover:animate-none",
          }),
        )}
      >
        Sponsor this neko 🐱
      ...
      <p className="mt-3 text-xs text-fd-muted-foreground">
        even ₹100 helps this cat survive finals week
      </p>

      {/* divider */}
      <div className="my-16 h-px w-full max-w-md bg-gradient-to-r from-transparent via-fd-border to-transparent" />
      ...
      <section className="flex flex-col items-center">
        ...
        <p className="mt-1 text-xs text-fd-muted-foreground">
          this space is warm and waiting 🐾
        </p>
      </section>

      {/* cute floating hearts svg */}
      <svg
        className="absolute bottom-10 right-10 w-24 opacity-60 animate-bounce"
        viewBox="0 0 100 100"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
          d="M50 80C50 80 15 55 15 35C15 25 25 20 32 25C38 29 50 40 50 40C50 40 62 29 68 25C75 20 85 25 85 35C85 55 50 80 50 80Z"
          fill="currentColor"
